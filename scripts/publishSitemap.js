...
const urlNode = (path) => `
  <url>
    <loc>https://webaadhi5e.github.io/comcast.github.io${path}</loc>
    <lastmod>${
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd">
  <url>
    <loc>https://webaadhi5e.github.io/comcast.github.io/</loc>
    <lastmod>${
      pagesObj["/index"].lastModified
        ? formatDate(new Date(pagesObj["/index"].lastModified))
        : today
    }</lastmod>
    <changefreq>daily</changefreq>
  </url>${Object.keys(pagesObj)
    .map((path) =>
      path.includes("index") ||
      path.includes("_") ||
      path.includes("404") ||
